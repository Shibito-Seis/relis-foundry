...
0.5.5 sur The Forge. Aucun contrôle visuel automatisé par navigateur :
...
L’archive installable est créée sous `build/relis-v0.5.5.zip`. Son `system.json` se
...
## Correctif 0.5.5 — emplacements propres à chaque objet
