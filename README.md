...
La version `0.3.4` stabilise l’interface de 10-E1-P : les 26 types d’Items partagent
...
L’archive installable est créée sous `build/relis-v0.3.4.zip`. Son `system.json` se
