...
utiliser `v0.2.2`. Le workflow construit `relis-v0.2.2.zip`, crée le tag et la
...
`https://github.com/Shibito-Seis/relis-foundry/releases/download/v0.2.2/relis-v0.2.2.zip`
