...
`v0.1.0`, puis lancer. Le workflow vérifie que ce tag correspond à la version du
manifeste, construit `relis-v0.1.0.zip`, crée le tag et la Release, puis y joint
l’archive.
...
`https://github.com/Shibito-Seis/relis-foundry/releases/download/v0.1.0/relis-v0.1.0.zip`
...
Le champ `compatibility.verified` est volontairement absent de la v0.1.0. Il sera
