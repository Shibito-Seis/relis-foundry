...
utiliser `v0.5.1`. Le workflow construit `relis-v0.5.1.zip`, crée le tag et la
...
`https://github.com/Shibito-Seis/relis-foundry/releases/download/v0.5.1/relis-v0.5.1.zip`
...
4. Suivre la recette `RE-LIS_Recette10_E3-P_v0.5.1.md` fournie avec les
