...
utiliser `v0.3.0`. Le workflow construit `relis-v0.3.0.zip`, crée le tag et la
...
`https://github.com/Shibito-Seis/relis-foundry/releases/download/v0.3.0/relis-v0.3.0.zip`
