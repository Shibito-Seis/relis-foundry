...
utiliser `v0.4.0`. Le workflow construit `relis-v0.4.0.zip`, crée le tag et la
...
`https://github.com/Shibito-Seis/relis-foundry/releases/download/v0.4.0/relis-v0.4.0.zip`
...
4. Suivre la recette détaillée `RE-LIS_Recette10_E2-P_v0.4.0.md` fournie avec les
