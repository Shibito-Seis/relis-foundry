...
utiliser `v0.3.5`. Le workflow construit `relis-v0.3.5.zip`, crée le tag et la
...
`https://github.com/Shibito-Seis/relis-foundry/releases/download/v0.3.5/relis-v0.3.5.zip`
