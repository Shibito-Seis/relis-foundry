# 10-K2-P — Matrice de conformité des compendiums personnels v0.8.2

Base publique inspectée avant modification : `edb6a8b`, tag `v0.8.0`, puis sources de recette v0.8.1 conservées dans le même arbre de travail. Canon relu avant codage : Bible v164, sections complètes des 20 Ascendances et des 12 Voies, catalogues personnels, contrats matériels, décisions Écarlithe et roadmap révisée. 10-K1-P reste validé. 10-K2-P reste en recette jusqu’à validation explicite de la v0.8.2.
...
| Exigence                     | Implémentation v0.8.2                                                                                                          | Contrôle automatisé                                           | Recette |
| ---------------------------- | ------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------- | ------- |
...
| Descriptions d’Ascendances   | Les 20 Items reprennent le contexte canonique de leur famille et, pour les Beastkins, la justification propre à la variante    | compte exact, seuil narratif et titre de section              | B       |
...
- Le prix unitaire ou l’avantage économique d’un achat par boîte sera raccordé au commerce de 10-J. La v0.8.2 ne fabrique aucun taux de remise.
...
Le code et les données de 10-K2-P sont construits et contrôlés localement. Cette fabrication ne vaut pas clôture : 10-K2-P demeure ouvert jusqu’à validation explicite de `RE-LIS_Recette10_K2-P_v0.8.2.md`.
